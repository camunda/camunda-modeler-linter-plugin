...
/* harmony import */ var bpmnlint_rules_no_gateway_join_fork__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! bpmnlint/rules/no-gateway-join-fork */ "./node_modules/bpmnlint/rules/no-gateway-join-fork.js");
/* harmony import */ var bpmnlint_rules_no_gateway_join_fork__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_no_gateway_join_fork__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var bpmnlint_rules_no_implicit_split__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! bpmnlint/rules/no-implicit-split */ "./node_modules/bpmnlint/rules/no-implicit-split.js");
/* harmony import */ var bpmnlint_rules_no_implicit_split__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_no_implicit_split__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var bpmnlint_rules_no_inclusive_gateway__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! bpmnlint/rules/no-inclusive-gateway */ "./node_modules/bpmnlint/rules/no-inclusive-gateway.js");
/* harmony import */ var bpmnlint_rules_no_inclusive_gateway__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_no_inclusive_gateway__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var bpmnlint_rules_single_blank_start_event__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! bpmnlint/rules/single-blank-start-event */ "./node_modules/bpmnlint/rules/single-blank-start-event.js");
/* harmony import */ var bpmnlint_rules_single_blank_start_event__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_single_blank_start_event__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var bpmnlint_rules_single_event_definition__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! bpmnlint/rules/single-event-definition */ "./node_modules/bpmnlint/rules/single-event-definition.js");
/* harmony import */ var bpmnlint_rules_single_event_definition__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_single_event_definition__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var bpmnlint_rules_start_event_required__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! bpmnlint/rules/start-event-required */ "./node_modules/bpmnlint/rules/start-event-required.js");
/* harmony import */ var bpmnlint_rules_start_event_required__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_start_event_required__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var bpmnlint_rules_sub_process_blank_start_event__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! bpmnlint/rules/sub-process-blank-start-event */ "./node_modules/bpmnlint/rules/sub-process-blank-start-event.js");
/* harmony import */ var bpmnlint_rules_sub_process_blank_start_event__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(bpmnlint_rules_sub_process_blank_start_event__WEBPACK_IMPORTED_MODULE_13__);
...
cache['bpmnlint/no-gateway-join-fork'] = bpmnlint_rules_no_gateway_join_fork__WEBPACK_IMPORTED_MODULE_7___default.a;


cache['bpmnlint/no-implicit-split'] = bpmnlint_rules_no_implicit_split__WEBPACK_IMPORTED_MODULE_8___default.a;


cache['bpmnlint/no-inclusive-gateway'] = bpmnlint_rules_no_inclusive_gateway__WEBPACK_IMPORTED_MODULE_9___default.a;


cache['bpmnlint/single-blank-start-event'] = bpmnlint_rules_single_blank_start_event__WEBPACK_IMPORTED_MODULE_10___default.a;


cache['bpmnlint/single-event-definition'] = bpmnlint_rules_single_event_definition__WEBPACK_IMPORTED_MODULE_11___default.a;


cache['bpmnlint/start-event-required'] = bpmnlint_rules_start_event_required__WEBPACK_IMPORTED_MODULE_12___default.a;


cache['bpmnlint/sub-process-blank-start-event'] = bpmnlint_rules_sub_process_blank_start_event__WEBPACK_IMPORTED_MODULE_13___default.a;
...
Object(camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__["registerBpmnJSPlugin"])(bpmn_js_bpmnlint__WEBPACK_IMPORTED_MODULE_1__["default"]);
Object(camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__["registerClientPlugin"])({
  bpmnlint: _bpmnlintrc__WEBPACK_IMPORTED_MODULE_2__["default"]
}, 'bpmn.modeler.linting');
...
var testRule = function testRule({
  moddleRoot,
  rule
}) {
...
Linter.prototype.resolveRules = function (config) {
  return this.resolveConfiguredRules(config).then(rulesConfig => {
    ...
    const enabledRules = parsedRules.filter(definition => definition.category !== 'off'); // load enabled rules
...
Linter.prototype.resolveConfiguredRules = function (config) {
  ...
  return Promise.all(parents.map(configName => {
...
Linter.prototype.lint = function (moddleRoot, config) {
  config = config || this.config; // load rules
...
Linter.prototype.parseRuleName = function (name) {
  const slashIdx = name.indexOf('/'); // resolve rule as built-in, if unprefixed
...
function normalizeConfig(config, pkg) {
  ...
  const validatedRules = Object.keys(rules).reduce((normalizedRules, name) => {
    const value = rules[name]; // prefix local rule definition
...
function Linting(config, bpmnjs, canvas, elementRegistry, eventBus, overlays) {
  ...
  if (!this._linterConfig || !this._linterConfig.config || !this._linterConfig.resolver) {
    console.warn('[bpmn-js-bpmnlint] You did not configure any lint rules to use. ' + 'Ensure you bundle and include your rules via the `linting.bpmnlint` option. ' + 'See https://github.com/bpmn-io/bpmn-js-bpmnlint#configure-lint-rules');
...
Linting.prototype._init = function () {
  var self = this;
  var button = this._button = Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["domify"])('<button class="bpmn-js-bpmnlint-button inactive"></button>');
  this.updateButton();
...
Linting.prototype.formatIssues = function (issues) {
  const reports = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["reduce"])(issues, function (reports, ruleReports, rule) {
    return reports.concat(ruleReports.map(function (report) {
      report.rule = rule;
      return report;
    }));
  }, []);
  return Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["groupBy"])(reports, function (report) {
    return report.id;
  });
};
...
Linting.prototype.activateLinting = function () {
  var self = this;
  this.setActive(true);
  this.lint().then(function (issues) {
...
Linting.prototype.setActive = function (active) {
  ...
  this._eventBus.fire('linting.toggle', {
    active: active
  });
};
/**
...
Linting.prototype.update = function () {
  ...
  this.lint().then(function (newIssues) {
    ...
    remove$$1 = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["assign"])(remove$$1, update);
    add = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["assign"])(add, update);
...
Linting.prototype.createElementIssues = function (elementId, elementIssues) {
  ...
  elementIssues = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["groupBy"])(elementIssues, function (elementIssue) {
    return elementIssue.category;
  });
  var errors = elementIssues.error,
      warnings = elementIssues.warn;
  var html = Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["domify"])('<div class="bpmn-js-bpmnlint-issues"><div class="icons"></div></div>');
  var icons = Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["query"])('.icons', html);
  var group;

  if (errors) {
    icons.appendChild(Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["domify"])('<span class="icon error">' + ErrorSvg + '</span>'));
    group = this.createGroup(errors, 'error', 'Errors', ErrorSvg);
    html.appendChild(group);
  }

  if (warnings) {
    icons.appendChild(Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["domify"])('<span class="icon warning">' + WarningSvg + '</span>'));
...
Linting.prototype.createGroup = function (issues, type, label, icon) {
  var group = Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["domify"])('<div class="group">' + '<div class="header ' + type + '">' + icon + label + '</div>' + '</div>');
  issues.forEach(function (issue) {
    var collapsable = Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["domify"])('<div class="collapsable ' + type + '">' + issue.message + '</div>');
...
Linting.prototype.removeIssues = function (issues) {
  ...
  for (var id in issues) {
    if (id === 'Process') {
      ...
      overlayId = this._overlayIds[id]; // ignore process
...
Linting.prototype.removeProcessIssues = function () {
  ...
  var html = Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["query"])('.bpmn-js-bpmnlint-process-issues', container);

  if (html) {
    Object(min_dom__WEBPACK_IMPORTED_MODULE_1__["remove"])(html);
  }
};
...
Linting.$inject = ['config.linting', 'bpmnjs', 'canvas', 'elementRegistry', 'eventBus', 'overlays'];
var index = {
  __init__: ['linting'],
...
module.exports = function () {
  function check(node, reporter) {
    ...
    if (isAny(node, ['bpmn:FlowNode', 'bpmn:SequenceFlow', 'bpmn:Participant', 'bpmn:Lane'])) {
...
module.exports = function () {
  function check(node, reporter) {
    if (!isAny(node, ['bpmn:Task', 'bpmn:Gateway', 'bpmn:SubProcess', 'bpmn:Event'])) {
      return;
    }
